clases/servicios/manejadores_de_aprobacion.py

from clases.interfaces.i_manejador_aprobacion import IManejadorAprobacion

# Validación de estudiante con estado de aprobación RETIRADO o ANULADO
class ManejadorEstadoInactivo(ManejadorAprobacion):
...
class ManejadorAsistencia(ManejadorAprobacion):
...
class ManejadorCalificacion(ManejadorAprobacion):
    def manejar(self, evaluacion_academica):
